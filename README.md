### Overview
Using clustering techniques, companies can identify the several segments of customers allowing them to target the potential user base.<br>
...
The dataset consists of following five features of customers:
